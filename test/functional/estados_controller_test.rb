...
class EstadosControllerTest < ActionController::TestCase
  ...
  test "should create estado" do
    assert_difference('Estado.count') do
      post :create, estado: { data: @estado.data, descricao: @estado.descricao, nome: @estado.nome, responsavel: @estado.responsavel }
    end
  ...
  test "should update estado" do
    put :update, id: @estado, estado: { data: @estado.data, descricao: @estado.descricao, nome: @estado.nome, responsavel: @estado.responsavel }
    assert_redirected_to estado_path(assigns(:estado))
  end
